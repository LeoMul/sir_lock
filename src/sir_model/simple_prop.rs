...
impl SimpleSampleBarabasi{
    ...
    -> GenGraphSIR{
        ...
        lockdown(lockdownparams,graph,&self.infected_list,&mut self.rng_type)
    ...
    pub fn propagate_until_completion_max_with_lockdown_new(&mut self,mut post_locked_down_graph:GenGraphSIR,lockparams:LockdownParameters) -> usize{
