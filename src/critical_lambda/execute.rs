...
fn _sim_ba_old(param:CriticalLambdaParams,json:Value,num_threads:Option<NonZeroUsize>){
...
fn _sim_small_world_old(param:CriticalLambdaParams,json:Value,num_threads:Option<NonZeroUsize>){
    fn collect_columns_sums(data:&Vec<Vec<(f64,f64)>>)-> Vec<(f64,f64,f64,f64)>{
